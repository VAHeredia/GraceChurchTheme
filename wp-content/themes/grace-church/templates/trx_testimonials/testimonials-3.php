...
if ( !function_exists( 'grace_church_template_testimonials_3_theme_setup' ) ) {
	add_action( 'grace_church_action_before_init_theme', 'grace_church_template_testimonials_3_theme_setup', 1 );
	function grace_church_template_testimonials_3_theme_setup() {
		grace_church_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 3/', 'grace-church'),
...
// Template output
if ( !function_exists( 'grace_church_template_testimonials_3_output' ) ) {
	function grace_church_template_testimonials_3_output($post_options, $post_data) {
		$show_title = true;
