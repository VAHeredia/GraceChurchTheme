...
//			var GRACE_CHURCH_EMAILER_ajax_nonce = "<?php //echo wp_create_nonce('ajax_nonce'); ?>//";/*+*/
			var GRACE_CHURCH_EMAILER_ajax_nonce = "<?php echo esc_attr(wp_create_nonce(admin_url('admin-ajax.php')));; ?>";
	...
	function build_page() {
		...
		<div class="trx_emailer">
			...
			<form id="trx_emailer_form" action="#" method="post" enctype="multipart/form-data">
				...
				<input type="hidden" value="<?php echo /*esc_attr($this->nonce);/*+*/ esc_attr(wp_create_nonce(admin_url('admin-ajax.php'))); ?>" name="nonce" />
